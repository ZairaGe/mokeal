...
import {
  ...
  padNumber,
  toInteger
} from "./chunk-22KFCRBQ.js";
import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR
} from "./chunk-GRTXFHT4.js";
import {
  NgTemplateOutlet,
  formatDate
} from "./chunk-26HPVZXZ.js";
import {
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_0 = goog.getMsg("Select month");
          i18n_0 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_0;
        } else {
          i18n_0 = $localize`:@@ngb.datepicker.select-month:Select month`;
        }
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_1 = goog.getMsg("Select month");
          i18n_1 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_1;
        } else {
          i18n_1 = $localize`:@@ngb.datepicker.select-month:Select month`;
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_2 = goog.getMsg("Select year");
          i18n_2 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_2;
        } else {
          i18n_2 = $localize`:@@ngb.datepicker.select-year:Select year`;
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_3 = goog.getMsg("Select year");
          i18n_3 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_3;
        } else {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        let i18n_4;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_4 = goog.getMsg("Previous month");
          i18n_4 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_4;
        } else {
          i18n_4 = $localize`:@@ngb.datepicker.previous-month:Previous month`;
        }
        let i18n_5;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_5 = goog.getMsg("Previous month");
          i18n_5 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_5;
        } else {
          i18n_5 = $localize`:@@ngb.datepicker.previous-month:Previous month`;
        }
        let i18n_6;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_6 = goog.getMsg("Next month");
          i18n_6 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_6;
        } else {
          i18n_6 = $localize`:@@ngb.datepicker.next-month:Next month`;
        }
        let i18n_7;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_7 = goog.getMsg("Next month");
          i18n_7 = MSG_C__USERS_MELIT_DESKTOP_MOKEAL_MOKEAL_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_DATEPICKER_MJS_7;
        } else {
...
//# sourceMappingURL=chunk-VGQGCZY2.js.map
