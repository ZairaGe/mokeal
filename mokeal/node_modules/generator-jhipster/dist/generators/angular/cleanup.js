...
export default asWritingTask(function cleanupOldFilesTask({ application, control }) {
    ...
    if (control.isJhipsterVersionLessThan('8.12.0')) {
        ...
        this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-endpoints-requests/metrics-endpoints-requests.component.html.ejs`);
        this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-endpoints-requests/metrics-endpoints-requests.component.ts.ejs`);
        this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-garbagecollector/metrics-garbagecollector.component.html.ejs`);
        this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-garbagecollector/metrics-garbagecollector.component.ts.ejs`);
        ...
        this.removeFile(`${application.clientSrcDir}app/admin/metrics/blocks/metrics-modal-threads/metrics-modal-threads.component.spec.ts.ejs`);
