...
export default class BootstrapGenerator extends AngularApplicationGenerator {
    [AngularApplicationGenerator.PREPARING]: Record<"translations", import("../../../base-core/types.js").GenericTask<any, import("../../../base/tasks.js").TaskParamWithControl & {
        source: import("../../types.js").Source;
    } & {
        application: import("../../types.js").Application<import("../../types.js").Entity<({
            propertyName: string;
    ...
    } & import("../../../base-simple-application/tasks.js").ApplicationDefaultsTaskParam<import("../../types.js").Application<import("../../types.js").Entity<({
        propertyName: string;
        propertyNameCapitalized?: string;
        propertyNameUpperSnakeCase?: string;
        propertyApiDescription?: string;
