...
import { fieldTypesValues } from "../../../lib/jhipster/field-types.js";
import { fieldTypes, validations } from "../../../lib/jhipster/index.js";
import { mutateData } from "../../../lib/utils/index.js";
import { mutateField } from "../entity.js";
const { BlobTypes, CommonDBTypes, RelationalOnlyDBTypes } = fieldTypes;
const { Validations: { MINLENGTH, MAXLENGTH, PATTERN, REQUIRED, UNIQUE }, } = validations;
const { TEXT } = BlobTypes;
const { BOOLEAN, BIG_DECIMAL, DOUBLE, DURATION, FLOAT, INSTANT, INTEGER, LOCAL_DATE, LONG, STRING, UUID, ZONED_DATE_TIME, LOCAL_TIME } = CommonDBTypes;
...
export function prepareCommonFieldForTemplates(entityWithConfig, field, generator) {
    ...
    if (field.fieldIsEnum) {
        if (Object.values(fieldTypesValues).includes(fieldType)) {
