...
export default class VueBootstrapGenerator extends ClientApplicationGenerator {
    [ClientApplicationGenerator.PREPARING]: Record<"translations", import("../../../base-core/types.js").GenericTask<any, import("../../../base/tasks.js").TaskParamWithControl & {
        source: import("../../../client/types.js").Source;
    } & {
        application: import("../../../client/types.js").Application<import("../../../client/entity.ts").Entity<({
            propertyName: string;
    ...
    } & import("../../../base-simple-application/tasks.js").ApplicationDefaultsTaskParam<import("../../../client/types.js").Application<import("../../../client/entity.ts").Entity<({
        propertyName: string;
        propertyNameCapitalized?: string;
        propertyNameUpperSnakeCase?: string;
        propertyApiDescription?: string;
    ...
    get preparing(): Record<"translations", import("../../../base-core/types.js").GenericTask<any, import("../../../base/tasks.js").TaskParamWithControl & {
        source: import("../../../client/types.js").Source;
    } & {
        application: import("../../../client/types.js").Application<import("../../../client/entity.ts").Entity<({
            propertyName: string;
