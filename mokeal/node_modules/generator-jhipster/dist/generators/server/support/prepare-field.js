...
import { buildMutateDataForProperty, mutateData } from "../../../lib/utils/index.js";
...
export const prepareMapstructField = (entity, field) => {
...
export default function prepareField(application, entityWithConfig, field, generator) {
    ...
    if (field.id && entityWithConfig.primaryKey) {
        ...
        if (!field.autoGenerate) {
            ...
            field.jpaGeneratedValue =
                field.jpaGeneratedValue || [INTEGER, LONG].includes(field.fieldType) ? defaultGenerationType : true;
