...
import { mutateApplicationPreparing, mutateField, mutateRelationship } from "../../application.js";
import { JavaApplicationGenerator } from "../../generator.js";
import { prepareEntity } from "../../support/index.js";
        ...
        return this.asPreparingEachEntityRelationshipTaskGroup({
            prepareRelationship({ application, relationship }) {
                mutateData(relationship, mutateRelationship, {
                    relationshipNameCapitalizedPlural: ({ relationshipNameCapitalized, relationshipName }) => relationshipName.length > 1
                        ? pluralize(relationshipNameCapitalized, { force: true })
                        : upperFirst(pluralize(relationshipName, { force: true })),
                    relationshipUpdateBackReference: ({ ownerSide, relationshipRightSide, otherEntity }) => !otherEntity.embedded && (application.databaseTypeNeo4j ? relationshipRightSide : !ownerSide),
                });
            },
        });
    }
