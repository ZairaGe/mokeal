...
import { isReservedTypescriptKeyword } from "../javascript-simple-application/support/reserved-words.js";
    ...
    get configuring() {
        return this.asConfiguringTaskGroup({
            ...
            configureDevServerPort() {
                if (this.jhipsterConfig.devServerPort !== undefined || this.jhipsterConfig.applicationIndex === undefined)
                    return;
        ...
        return this.asPreparingEachEntityRelationshipTaskGroup({
            preparing({ entity, relationship }) {
                if (isReservedTypescriptKeyword(relationship.relationshipName)) {
                    throw new Error(`The relationship name "${relationship.relationshipName}" in entity "${entity.name}" is a reserved TypeScript keyword.`);
                }
            },
        });
    }
