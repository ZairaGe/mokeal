...
import { getEnumInfo } from "../../../base-application/support/enum.js";
import { CLIENT_MAIN_SRC_DIR } from "../../../generator-constants.js";
import { findLanguageForTag } from "../../../languages/support/languages.js";
import TranslationData, { createTranslationsFileFilter, createTranslationsFilter } from "../../../languages/translation-data.js";
import { ClientApplicationGenerator } from "../../generator.js";
export default class I18NGenerator extends ClientApplicationGenerator {
    ...
    get writing() {
        return this.asWritingTaskGroup({
            async writeClientTranslations({ application }) {
                await Promise.all(this.languagesToGenerate.map(({ languageTag }) => this.writeFiles({
                    sections: {
                        clientI18nFiles: [
                            {
        ...
        return this.asWritingEntitiesTaskGroup({
            ...
            async writeEntityFiles({ application, entities }) {
                ...
                await Promise.all(entities
                    ...
                    .flatMap(entity => entity.fields.flatMap(field => {
                    if (!field.fieldIsEnum)
                        return [];
                    return this.languagesToGenerate.map(({ languageTag }) => this.writeFiles({
                        sections: {
                            enumBaseFiles: [
                                {
                                    templates: [
                                        {
                                            ...
                                            destinationFile: context => `${context.clientI18nDir}${context.lang}/${context.clientRootFolder}${context.enumInstance}.json`,
                                        },
                                    ],
                                },
                            ],
    ...
    queueLoadLanguages({ enableTranslation, clientI18nDir, nativeLanguage, fallbackLanguage = 'en', }) {
        this.queueTask({
            method: async () => {
