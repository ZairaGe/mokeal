    ...
    get preparing() {
        return this.asPreparingTaskGroup({
            async preparing({ application }) {
                ...
                mutateData(application.githubActions, Object.fromEntries(dependabotConfig.runs.steps
                    .map(({ uses }) => uses.split('@'))
                    .map(([name, version]) => [name, `${name}@${this.useVersionPlaceholders ? 'VERSION' : version}`])));
            },
        });
    }
