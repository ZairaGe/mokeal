...
export function prepareRelationshipForLiquibase({ application, entity, relationship, }) {
    prepareRelationshipForDatabase({ application: application, entity, relationship });
