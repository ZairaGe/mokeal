...
import { ALPHANUMERIC_PATTERN } from "../../lib/constants/jdl.js";
...
import authenticationTypes from "../../lib/jhipster/authentication-types.js";
import { createBase64Secret, createSecret } from "../../lib/utils/secret.js";
    ...
    configs: {
        ...
        serverPort: {
            prompt: gen => ({
                ...
                type: 'input',
                validate: (input) => (/^(\d*)$/.test(input) ? true : 'This is not a valid port number.'),
        ...
        authenticationType: {
            ...
            prompt: (gen, config) => ({
                ...
                choices: () => gen.jhipsterConfigWithDefaults.applicationType !== APPLICATION_TYPE_MONOLITH
        ...
        feignClient: {
            ...
            prompt: gen => ({
                ...
                when: ({ reactive }) => [APPLICATION_TYPE_MICROSERVICE].includes(gen.jhipsterConfigWithDefaults.applicationType) &&
