 ...
 * @param {Object} entity
 */
export const cleanupOldFiles = asWritingEntitiesTask(function cleanupOldFiles({ application: { packageFolder, srcMainJava, srcTestJava, searchEngineElasticsearch }, control, entities, }) {
