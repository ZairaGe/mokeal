...
import { JavaApplicationGenerator } from "../../../java/generator.js";
import { moveToJavaPackageTestDir } from "../../../java/support/files.js";
        ...
        return this.asPostWritingTaskGroup({
            ...
            upgradeJunitJupiter({ application, source }) {
                ...
                if (springBootJunitJupiterVersion && gt(springBootJunitJupiterVersion, junitJupiterVersion)) {
                    throw new Error(`Spring Boot provides junit-jupiter.version=${application.javaManagedProperties['junit-jupiter.version']}, which is compatible with Cucumber. Custom version can be dropped.`);
                }
