 ...
 */
export const getTestcontainerSupport = ({ databaseType, springBoot4, dockerContainers, }) => {
    return ({
        mariadb: {
...
export const getH2MavenDefinition = ({ implementsTestcontainersSupport, packageFolder, }) => {
    const excludeContainerPlugin = implementsTestcontainersSupport
        ? [
            {
                inProfile: 'dev',
...
export const getDatabaseTypeMavenDefinition = (databaseType, { inProfile }) => {
    ...
    const testContainerDeps = [{ inProfile, ...testContainer }];
    if (inProfile === 'prod') {
