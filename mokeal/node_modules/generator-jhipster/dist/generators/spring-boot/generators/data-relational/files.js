...
export const sqlFiles = asWriteFilesSection({
    serverFiles: [
        {
    ...
    testContainers: [
        ...
        },
        {
            ...
            templates: [
                {
                    sourceFile: data => `config/DatabaseTestcontainer_${data.implementsDynamicSourceTestcontainersSupport ? 'devprod' : 'prodonly'}.java`,
                },
            ],
        },
        {
...
export const h2Files = asWriteFilesSection({
    serverResource: [
        {
...
export const mysqlFiles = asWriteFilesSection({
    serverTestSources: [
        {
            ...javaTestResourceTemplatesBlock(),
...
export const serverFiles = mergeSections(sqlFiles, addSectionsCondition(h2Files, context => context.devDatabaseTypeH2Any), addSectionsCondition(mysqlFiles, context => context.prodDatabaseTypeMysql));
