...
const isNodeVersionCompliantWithRequirement = (gatheredFromEnvironment, requiredVersion) => !semver.satisfies(gatheredFromEnvironment, requiredVersion);
const getNodeReleaseFromCurrentProcess = () => process.release || {};
const isNodeLTS = (release) => Boolean(release?.lts);
