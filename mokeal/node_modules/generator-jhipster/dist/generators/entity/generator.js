...
import { askForDTO, askForFields, askForFieldsToRemove, askForFiltering, askForMicroserviceJson, askForPagination, askForReadOnly, askForRelationsToRemove, askForRelationships, askForService, askForUpdate, } from "./prompts.js";
    ...
    get postPreparing() {
        return this.asPostPreparingTaskGroup({
            isBuiltInEntity({ application }) {
                if ((application.generateBuiltInUserEntity && this.entityData.name.toLowerCase() === 'user)') ||
