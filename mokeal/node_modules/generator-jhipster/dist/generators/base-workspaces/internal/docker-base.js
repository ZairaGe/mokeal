...
import { asPreparingWorkspacesTask } from "../support/task-type-inference.js";
 ...
 */
export const configureImageNames = asPreparingWorkspacesTask(function configureImageNames({ applications, }) {
    for (const app of applications) {
