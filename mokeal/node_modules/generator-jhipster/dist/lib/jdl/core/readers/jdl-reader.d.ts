 ...
 */
export declare function parseFromFiles(files: string[], runtime: JDLRuntime): import("../types/parsed.js").ParsedJDLApplications;
/**
 * Parses the given content and returns the resulting intermediate object.
 * @param content the JDL content to parse.
 * @returns {Object} the intermediate object.
 */
export declare function parseFromContent(content: string, runtime: JDLRuntime): import("../types/parsed.js").ParsedJDLApplications;
export declare function getCstFromContent(content: string, runtime: JDLRuntime): import("chevrotain").CstNode;
/**
