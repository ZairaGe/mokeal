...
export function parse(input, runtime, options) {
...
export function getCst(input, runtime, options) {
...
export function getSyntacticAutoCompleteSuggestions(input, runtime, options) {
    const lexResult = runtime.lexer.tokenize(input);
