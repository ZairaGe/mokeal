...
import type { ParsedJDLOptionConfig, ParsedJDLUseOption } from '../../core/types/parsed.ts';
 ...
 */
export declare function convertOptions(parsedOptions: Record<string, ParsedJDLOptionConfig | Record<string, ParsedJDLOptionConfig>> | undefined, useOptions: ParsedJDLUseOption[]): AbstractJDLOption[];
