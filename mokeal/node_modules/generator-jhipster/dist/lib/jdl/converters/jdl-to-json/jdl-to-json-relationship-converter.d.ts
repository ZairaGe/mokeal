 ...
 */
export declare function convert(jdlRelationships?: JDLRelationship[], entityNames?: string[]): Map<any, any>;
export declare const otherRelationshipType: (relationshipType: string) => string;
