...
import { getDatabaseTypeMavenDefinition, getH2MavenDefinition, getTestcontainerSupport, javaSqlDatabaseArtifacts, } from "./internal/dependencies.js";
    ...
    get preparing() {
        return this.asPreparingTaskGroup({
            async preparing({ application, applicationDefaults }) {
                ...
                applicationDefaults({
                    implementsDynamicSourceTestcontainersSupport: data => Boolean(!application.devDatabaseTypeH2Any && data.testcontainerClass && data.springBoot4),
    ...
    get postWriting() {
        return this.asPostWritingTaskGroup({
            ...
            async nativeMavenBuildTool({ application, source }) {
                if (!application.buildToolMaven || !application.graalvmSupport)
                    return;
