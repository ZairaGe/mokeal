...
import { addSectionsCondition, mergeSections } from "../base-core/support/index.js";
...
const imperativeConfigFiles = asWriteFilesSection({
    imperativeFiles: [
        {
...
const reactiveConfigFiles = asWriteFilesSection({
    reactiveFiles: [
        {
            path: `${SERVER_MAIN_SRC_DIR}_package_/`,
            renameTo: moveToJavaPackageSrcDir,
...
const accountFiles = asWriteFilesSection({
    accountResource: [
        {
            path: `${SERVER_MAIN_SRC_DIR}_package_/`,
            renameTo: moveToJavaPackageSrcDir,
...
const userManagementFiles = asWriteFilesSection({
    userManagementFiles: [
        {
            path: `${SERVER_MAIN_SRC_DIR}_package_/`,
            renameTo: moveToJavaPackageSrcDir,
...
const swaggerFiles = asWriteFilesSection({
    swagger: [
        {
            path: `${SERVER_MAIN_SRC_DIR}_package_/`,
            renameTo: moveToJavaPackageSrcDir,
 ...
 */
export const baseServerFiles = asWriteFilesSection({
    readme: [
        {
...
export const serverFiles = mergeSections(baseServerFiles, addSectionsCondition(accountFiles, context => context.generateAuthenticationApi), addSectionsCondition(userManagementFiles, context => context.generateUserManagement), addSectionsCondition(imperativeConfigFiles, context => !context.reactive), addSectionsCondition(reactiveConfigFiles, context => context.reactive), addSectionsCondition(swaggerFiles, context => context.enableSwaggerCodegen));
