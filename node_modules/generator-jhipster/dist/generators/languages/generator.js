...
import { findLanguageForTag } from "./support/languages.js";
...
export default class LanguagesGenerator extends BaseApplicationGenerator {
    ...
    get supportedLanguages() {
        return this.getContextData(CONTEXT_DATA_SUPPORTED_LANGUAGES);
    }
    ...
    get composing() {
        return this.asComposingTaskGroup({
            async bootstrap() {
                ...
                const { clientFramework = 'no', skipServer, backendType = 'Java' } = this.jhipsterConfigWithDefaults;
