...
export declare const replaceTranslationKeysWithText: (getWebappTranslation: GetWebappTranslationCallback, body: string, regexp: string, { keyPattern, interpolatePattern, wrapTranslation, escapeHtml, stringify }?: TranslationReplaceOptions) => string;
export declare const createJhiTransformTranslateReplacer: (getWebappTranslation: GetWebappTranslationCallback, translateOptions?: TranslationReplaceOptions) => (body: string) => string;
export declare const createJhiTransformTranslateStringifyReplacer: (getWebappTranslation: GetWebappTranslationCallback) => (body: string) => string;
