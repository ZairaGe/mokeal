...
export const createTranslationsFilter = ({ clientI18nDir, nativeLanguage, fallbackLanguage, }) => {
...
export default class TranslationData {
    ...
    loadFromStreamTransform({ enableTranslation, clientI18nDir, nativeLanguage, fallbackLanguage = 'en', }) {
