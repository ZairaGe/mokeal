...
export const applicationKubernetesFiles = (suffix = '') => asWriteFilesSection({
    database: [
        {
            ...
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.app.baseName.toLowerCase()}-${data.app.prodDatabaseType ?? data.app.databaseType}.yml`,
        ...
        },
        {
            ...
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/templates/${data.app.baseName.toLowerCase()}-${data.app.prodDatabaseType ?? data.app.databaseType}.yml`,
            templates: [{ sourceFile: data => `db/${data.app.prodDatabaseType ?? data.app.databaseType}.yml` }],
        },
    ],
    searchEngine: [
        {
            ...
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}${data.app.baseName.toLowerCase()}-elasticsearch.yml`,
...
export const applicationHelmFiles = (suffix = '') => asWriteFilesSection({
    chart: [
        {
...
export const applicationKnativeFiles = (suffix = '') => asWriteFilesSection({
    deployment: [
        {
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}${data.app.baseName.toLowerCase()}-service.yml`,
    ...
    gateway: [
        {
            ...
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}${data.app.baseName.toLowerCase()}-gateway.yml`,
            templates: ['istio/gateway.yml'],
        },
    ],
    istio: [
        {
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}${data.app.baseName.toLowerCase()}-virtual-service.yml`,
            templates: ['istio/virtual-service.yml'],
        },
        {
            renameTo: data => `${data.app.baseName.toLowerCase()}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}${data.app.baseName.toLowerCase()}-destination-rule.yml`,
            templates: ['istio/destination-rule.yml'],
        },
    ],
});
export const deploymentKubernetesFiles = (suffix = '') => asWriteFilesSection({
    namespace: [
        {
    ...
    serviceDiscovery: [
        {
            ...
            renameTo: data => `${data.generatorTypeK8s ? 'registry' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}jhipster-registry.yml`,
            templates: ['registry/jhipster-registry.yml'],
        },
        {
            condition: generator => generator.serviceDiscoveryTypeEureka,
            renameTo: data => `${data.generatorTypeK8s ? 'registry' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}application-configmap.yml`,
        ...
        {
            condition: generator => generator.serviceDiscoveryTypeConsul,
            renameTo: data => `${data.generatorTypeK8s ? 'registry' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}consul-config-loader.yml`,
    ...
    istio: [
        {
            ...
            renameTo: data => `${data.generatorTypeK8s ? 'istio' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}grafana-gateway.yml`,
            templates: ['istio/gateway/grafana-gateway.yml'],
        },
        {
            condition: generator => generator.istio,
            renameTo: data => `${data.generatorTypeK8s ? 'istio' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}zipkin-gateway.yml`,
            templates: ['istio/gateway/zipkin-gateway.yml'],
        },
        {
            condition: generator => generator.istio,
            renameTo: data => `${data.generatorTypeK8s ? 'istio' : 'csvc'}-${suffix}/${data.generatorTypeK8s ? '' : 'templates/'}kiali-gateway.yml`,
            templates: ['istio/gateway/kiali-gateway.yml'],
        },
    ],
});
export const deploymentHelmFiles = (suffix = '') => asWriteFilesSection({
    chart: [
        {
...
export const deploymentKnativeFiles = () => asWriteFilesSection({
    common: [
        {
