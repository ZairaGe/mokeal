        ...
        return this.asDefaultTaskGroup({
            checkGradle({ application }) {
                if (application.buildToolGradle && !application.reactive && application.databaseTypeSql && !application.springBoot4) {
                    ...
                    throw new Error("GraalVM native image v25 is not supported by Gradle 8. Hibernate 6 hibernate-enhance-maven-plugin doesn't support Gradle 9.");
                }
            },
    ...
    get postWriting() {
        return this.asPostWritingTaskGroup({
            ...
            async customizeMaven({ application, source }) {
                ...
                if (!buildToolMaven)
                    return;
                const { nativeLanguageDefinition, languagesDefinition } = application;
