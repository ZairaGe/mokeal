...
import { type MavenProjectLike } from '../internal/pom-sort.ts';
import XmlStorage from '../internal/xml-store.ts';
import type { MavenAnnotationProcessor, MavenDependency, MavenDistributionManagement, MavenPlugin, MavenProfile, MavenProperty, MavenRepository } from '../types.ts';
export default class PomStorage extends XmlStorage {
    ...
    protected addDependencyAt(node: MavenProjectLike, { additionalContent, ...dependency }: MavenDependency): void;
    protected addPluginAt(node: MavenProjectLike, { additionalContent, ...artifact }: MavenPlugin): void;
