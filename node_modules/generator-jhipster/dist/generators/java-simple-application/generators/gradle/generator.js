...
export default class GradleGenerator extends BaseSimpleApplicationGenerator {
        ...
        return this.asPreparingTaskGroup({
            ...
            prepareConventionsPlugins({ applicationDefaults }) {
                applicationDefaults({
                    ...
                    gradleDevelocityHost: ({ gradleDevelocityHost }) => !gradleDevelocityHost || gradleDevelocityHost.startsWith('https://') ? gradleDevelocityHost : `https://${gradleDevelocityHost}`,
                });
            },
            addSourceNeedles({ application, source }) {
                ...
                source.addGradleRepository = repository => this.editFile('build.gradle', createNeedleCallback({ needle: 'gradle-repositories', contentToAdd: repository.repository }));
