...
import { checkJava, generatedAnnotationTransform, isReservedJavaKeyword, javaMainPackageTemplatesBlock, matchMainJavaFiles, packageInfoTransform, } from "../java/support/index.js";
/**
            ...
            fixConfig() {
                if (this.jhipsterConfig.packageFolder) {
                    ...
                    if (this.jhipsterConfig.packageName !== packageName) {
                        throw new Error(`The package name "${this.jhipsterConfig.packageName}" does not match the package folder "${this.jhipsterConfig.packageFolder}". Using "${packageName}" as package name.`);
                    }
                }
            },
        });
                ...
                if (this.packageInfoFile && srcMainJava) {
                    ...
                    this.queueTransformStream({
                        ...
                        javadocs: {
                            ...
                            ...Object.fromEntries(application.entityPackages.flatMap(pkg => [
