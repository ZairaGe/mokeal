...
import { addGradlePluginCallback, applyFromGradleCallback } from "../java-simple-application/generators/gradle/internal/needles.js";
import { createPomStorage } from "../java-simple-application/generators/maven/support/pom-store.js";
...
export default class HerokuGenerator extends BaseApplicationGenerator {
    ...
    get default() {
        return this.asDefaultTaskGroup({
            async gitInit() {
                if (this.jhipsterConfig.herokuDeployType !== 'git')
                    return;
    ...
    async spawnHerokuCommand(command, opt = {}) {
        ...
        return (await this.printChildOutput(child));
    }
    async spawnHeroku(args, opt = {}) {
        const { verboseInfo, ...spawnOptions } = opt;
