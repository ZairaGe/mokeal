...
export * from "../lib/constants/yeoman.js";
export * from "../lib/constants/jhipster.js";
...
// Version of Node, NPM
export const RECOMMENDED_NODE_VERSION = readFileSync(join(fileURLToPath(import.meta.url), '../init/resources/.node-version'), 'utf-8').trim();
