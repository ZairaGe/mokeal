...
import { getDBCExtraOption } from "../../spring-boot/generators/data-relational/support/database-data.js";
import { getJdbcUrl, getR2dbcUrl } from "../../spring-boot/generators/data-relational/support/database-url.js";
...
export const jhipster7deprecatedProperties = {
    devDatabaseType: {
        ...
        get: ({ data }) => {
            ...
            console.log(`JHipster v8 behavior change(devDatabaseType is only used in jhipster:spring-boot:data-relational generator): devDatabaseType is not set, using fallback: ${fallbackValue}`);
    ...
    prodDatabaseType: {
        ...
        get: ({ data }) => {
            ...
            console.log(`JHipster v8 behavior change(prodDatabaseType is only used in jhipster:spring-boot:data-relational generator): devDatabaseType is not set, using fallback: ${data.databaseType}`);
...
const ejsBuiltInProperties = new Set(['__append', '__line', 'escapeFn', 'include', 'undefined']);
const javascriptBuiltInProperties = new Set(['parseInt', 'Boolean', 'JSON', 'Object', 'toString']);
const getPropertyBuilder = ({ log = (msg) => console.log(msg) } = {}) => (context, prop) => {
