...
import { normalizePathEnd } from "../../../lib/utils/path.js";
 ...
 */
export const filterRelevantRelationships = (relationships) => relationships.filter(rel => rel.persistableRelationship || rel.relationshipEagerLoad);
/**
 * @private
 ...
 */
export const generateEntityClientImports = (relationships, _dto, clientFramework) => {
 ...
 */
export const generateTsTestEntityForFields = (fields) => {
...
export const stringifyTsEntity = (data, options = {}) => {
 ...
 * Generate a test entity, according to the type
 */
export const generateTestEntity = (fields, index = 'random') => {
    const entries = fields.flatMap(field => {
        if (index === 'random') {
        ...
        return [[field.propertyName, generateTestEntityId(field.fieldType, index, false)]];
    });
    return Object.fromEntries(entries);
};
