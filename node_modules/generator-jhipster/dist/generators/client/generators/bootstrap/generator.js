...
import clientCommand from "../../command.js";
import { mutateEntity, mutateField } from "../../entity.js";
import { ClientApplicationGenerator } from "../../generator.js";
import { filterEntitiesForClient, filterEntityPropertiesForClient, preparePostEntityClientDerivedProperties } from "../../support/index.js";
        ...
        return this.asPreparingEachEntityTaskGroup({
            preparing({ application, entity }) {
                mutateData(entity, mutateEntity, {
                    __override__: false,
                    entityPage: ({ microserviceName, entityFileName }) => microserviceName && application.microfrontend && application.applicationTypeMicroservice
