 ...
 */
const isNumber = (input) => !Number.isNaN(filterNumber(input));
/**
 * @private
 * @param {any} input input
 * @returns {boolean} true if input is a signed number; false otherwise
 */
const isSignedNumber = (input) => !Number.isNaN(filterNumber(input, true));
/**
 * @private
 * @param {any} input input
 * @returns {boolean} true if input is a signed decimal number; false otherwise
 */
const isSignedDecimalNumber = (input) => !Number.isNaN(filterNumber(input, true, true));
