...
export default class WorkspacesGenerator extends BaseWorkspacesGenerator {
        ...
        return this.asInitializingTaskGroup({
            loadConfig() {
                ...
                this.generateWorkspaces =
                    (this.workspaces ?? this.jhipsterConfig.monorepository) || Boolean(this.packageJson?.get('workspaces'));
    ...
    get configuring() {
        return this.asConfiguringTaskGroup({
            defaults() {
                this.jhipsterConfig.baseName ??= 'workspaces';
            },
    ...
    get loadingWorkspaces() {
        return this.asDefaultTaskGroup({
            configurePackageManager({ applications }) {
                if (this.workspacesConfig.nodePackageManager || !this.generateWorkspaces)
                    return;
        ...
        return this.asPostWritingTaskGroup({
            generatePackageJson({ applications }) {
                ...
                if (applications.some(app => app.clientFrameworkAngular)) {
                    const { dependencies: { rxjs }, devDependencies: { webpack: webpackVersion, 'browser-sync': browserSyncVersion }, } = this.readResourcesPackageJson(this.fetchFromInstalledJHipster('angular', 'resources', 'package.json'));
                    this.packageJson.merge({
                        devDependencies: {
                ...
                if (applications.some(app => app.clientFrameworkReact)) {
                    const { dependencies: { react: reactVersion, 'react-dom': reactDomVersion }, devDependencies: { 'browser-sync': browserSyncVersion }, } = this.readResourcesPackageJson(this.fetchFromInstalledJHipster('react', 'resources', 'package.json'));
                    this.packageJson.merge({
                        overrides: {
                            'browser-sync': browserSyncVersion,
                            react: reactVersion,
