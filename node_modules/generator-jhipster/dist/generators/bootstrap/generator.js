...
import BaseGenerator, { CommandBaseGenerator } from "../base/index.js";
...
export default class BootstrapGenerator extends CommandBaseGenerator {
    ...
    async commitTask() {
        await this.commitSharedFs({ refresh: this.refreshOnCommit }, ...this.env.findFeature('commitTransformFactory').flatMap(({ feature }) => feature()));
    }
    /**
    ...
    async commitSharedFs({ log, ...options } = {}, ...transforms) {
        ...
        if (!this.skipPrettier) {
            ...
            if (!this.skipEslint) {
                prettierTransforms.push(await createESLintTransform.call(this, { ignoreErrors }), await createRemoveUnusedImportsTransform.call(this, { ignoreErrors }));
            }
            ...
            customizeActions = (actions, { separator }) => {
                return [
                    ...
                    ...(separator ? [separator()] : []),
                    {
                        ...
                        value: async ({ file }) => {
                            const { applyChangesToFileOrCopy } = await import("../../lib/ci/apply-patch-to-template.js");
