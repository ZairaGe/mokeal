...
import { loadDerivedConfig } from "../../../base-core/internal/config-def.js";
import { isWin32 } from "../../../base-core/support/index.js";
import serverCommand from "../../../server/command.js";
import { mutateApplication } from "../../application.js";
import { mutateRelationship, mutateRelationshipWithEntity } from "../../entity.js";
import BaseApplicationGenerator from "../../index.js";
import { convertFieldBlobType, getBlobContentType, isFieldBinaryType, isFieldBlobType } from "../../internal/types/field-types.js";
import { createAuthorityEntity, createUserEntity, createUserManagementEntity } from "../../internal/utils.js";
import { addFakerToEntity, derivedPrimaryKeyProperties, loadEntitiesAnnotations, loadEntitiesOtherSide, prepareCommonFieldForTemplates, prepareEntity as prepareEntityForTemplates, prepareEntityPrimaryKeyForTemplates, preparePostEntityCommonDerivedProperties, prepareRelationship, stringifyApplicationData, } from "../../support/index.js";
    ...
    get preparing() {
        return this.asPreparingTaskGroup({
            ...
            loadNodeDependencies({ application }) {
                ...
                this.loadNodeDependenciesFromPackageJson(application.nodeDependencies, this.fetchFromInstalledJHipster('common', 'resources', 'package.json'));
            },
            loadDefaults({ application, applicationDefaults }) {
                let { applyDefaults } = this.options;
                applyDefaults ??= getConfigWithDefaults;
