...
export default function prepareRelationship(entityWithConfig, relationship, ignoreMissingRequiredRelationship = false) {
    ...
    if (entityWithConfig.dto === MAPSTRUCT && otherEntity.dto !== MAPSTRUCT && !otherEntity.builtInUser) {
        this.log.warn(`Entity ${entityName}: this entity has the DTO option, and it has a relationship with entity "${otherEntity.name}" that doesn't have the DTO option. This will result in an error.`);
    }
