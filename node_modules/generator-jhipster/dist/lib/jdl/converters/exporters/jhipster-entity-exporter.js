...
function filterOutEntitiesByMicroservice(entities) {
    return entities.filter(entity => !(entity.microserviceName && entity.microserviceName.toLowerCase() !== configuration.application.name.toLowerCase()));
}
