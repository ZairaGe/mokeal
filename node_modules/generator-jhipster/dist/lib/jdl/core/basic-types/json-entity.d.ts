...
declare class JSONEntity {
    ...
    addFields(fields: JSONField[]): void;
    addField(field: JSONField): void;
    addRelationships(relationships: JSONRelationship[]): void;
    addRelationship(relationship: JSONRelationship): void;
    setOptions(options?: Partial<JSONEntity>): void;
    setAnnotations(annotations?: Record<string, boolean | string | number | undefined>): void;
}
