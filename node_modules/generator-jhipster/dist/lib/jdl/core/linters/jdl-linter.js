...
function getAllFieldDeclarations(entityDeclarations) {
    ...
    return entityDeclarations.reduce((fieldDeclarations, entityDeclaration) => fieldDeclarations.concat(getFieldDeclarationsFromEntity(entityDeclaration)), []);
}
function getFieldDeclarationsFromEntity(entityDeclaration) {
    const entityBody = entityDeclaration.children.entityBody?.[0];
    return entityBody?.children.fieldDeclaration ?? [];
}
