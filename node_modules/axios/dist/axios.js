...
(function (global, factory) {
  ...
  function merge() {
    ...
    var assignValue = function assignValue(val, key) {
      ...
      var existing = hasOwnProperty(result, targetKey)
        ? result[targetKey]
        : undefined;
    ...
    for (
      var _len = arguments.length, objs = new Array(_len), _key2 = 0;
      _key2 < _len;
      _key2++
    ) {
  ...
  var freezeMethods = function freezeMethods(obj) {
    reduceDescriptors(obj, function (descriptor, name) {
      ...
      if (
        isFunction$1(obj) &&
        ["arguments", "caller", "callee"].includes(name)
      ) {
        return false;
      }
      var value = obj[name];
  ...
  // eslint-disable-next-line no-control-regex
  var INVALID_BYTE_STRING_HEADER_VALUE_CHARS = new RegExp(
    "[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+",
    "g",
  );
  ...
  var sanitizeByteStringHeaderValue = function sanitizeByteStringHeaderValue(
    value,
  ) {
  ...
  function redactConfig(config, redactKeys) {
    var lowerKeys = new Set(
      redactKeys.map(function (k) {
    ...
    var _visit = function visit(source) {
      ...
      if (utils$1.isArray(source)) {
        ...
        for (
          var _i = 0, _Object$entries = Object.entries(source);
          ...
          var reducedValue = lowerKeys.has(key.toLowerCase())
            ? REDACTED
            : _visit(value);
          if (!utils$1.isUndefined(reducedValue)) {
      ...
      [
        {
          ...
          value: function toJSON() {
            ...
            var redactKeys =
              config && utils$1.hasOwnProp(config, "redact")
                ? config.redact
                : undefined;
  ...
  function formDataToJSON(formData) {
    function buildPath(path, value, target, index) {
      ...
      if (
        !utils$1.hasOwnProp(target, name) ||
        !utils$1.isObject(target[name])
      ) {
        target[name] = [];
      }
    ...
    utils$1.forEach(
      ...
      function computeConfigValue(prop) {
        if (
          ...
          return;
        var merge = utils$1.hasOwnProp(mergeMap, prop)
          ? mergeMap[prop]
          : mergeDeepProperties;
  ...
  var streamChunk = /*#__PURE__*/ _regenerator().m(
          ...
          function (_context2) {
            while (1)
              switch ((_context2.p = _context2.n)) {
                ...
                case 3:
                  if (
                    !(_iteratorAbruptCompletion = !(_step = _context2.v).done)
                  ) {
                    _context2.n = 5;
                    break;
                  }
                ...
                switch ((_context4.p = _context4.n)) {
                  case 0:
                    ((_resolveConfig = resolveConfig(config)),
                      ...
                      (maxContentLength = _resolveConfig.maxContentLength),
                      (maxBodyLength = _resolveConfig.maxBodyLength));
                    hasMaxContentLength =
                      utils$1.isNumber(maxContentLength) &&
                      maxContentLength > -1;
                    hasMaxBodyLength =
                      utils$1.isNumber(maxBodyLength) && maxBodyLength > -1;
                  ...
                  case 7:
                    ...
                    isCredentialsSupported =
                      isRequestSupported && "credentials" in Request.prototype; // If data is FormData and Content-Type is multipart/form-data without boundary,
                    ...
                    request =
                      isRequestSupported && new Request(url, resolvedOptions);
                    _context4.n = 8;
                  ...
                  case 8:
                    ...
                    if (
                      !(
                        declaredLength != null &&
                        declaredLength > maxContentLength
                      )
                    ) {
                      _context4.n = 9;
                      break;
                  ...
                  case 14:
                    if (
                      !(
                        _t5 &&
                        _t5.name === "TypeError" &&
                        /Load failed|fetch/i.test(_t5.message)
                      )
                    ) {
                      _context4.n = 15;
                      break;
  ...
  function dispatchRequest(config) {
    ...
    var adapter = adapters.getAdapter(
  ...
  function assertOptions(options, schema, allowUnknown) {
    ...
    while (i-- > 0) {
      ...
      var validator = Object.prototype.hasOwnProperty.call(schema, opt)
        ? schema[opt]
        : undefined;
      if (validator) {
