...
- [Axios Migration Codemod](https://github.com/axios/axios-migration-codemod) _(if available)_
- [ESLint Rules for Axios 1.x](https://github.com/axios/eslint-plugin-axios) _(if available)_
...
- [Axios Discord Community](https://discord.gg/axios) _(if available)_

### Related Issues

- [Error Handling Changes Discussion](https://github.com/axios/axios/issues/7208)
- [Migration Guide Request](https://github.com/axios/axios/issues/xxxx) _(link to related issues)_
...
_This migration guide is maintained by the community. If you find errors or have suggestions, please [open an issue](https://github.com/axios/axios/issues) or submit a pull request._
