...
var AsapAction = (function(_super) {
  ...
  AsapAction2.prototype.requestAsyncId = function(scheduler, id, delay2) {
    ...
    return scheduler._scheduled || (scheduler._scheduled = immediateProvider.setImmediate(
...
var AnimationFrameAction = (function(_super) {
  ...
  AnimationFrameAction2.prototype.requestAsyncId = function(scheduler, id, delay2) {
    ...
    scheduler.actions.push(this);
    return scheduler._scheduled || (scheduler._scheduled = animationFrameProvider.requestAnimationFrame(
      function() {
...
function fromEvent(target, eventName, options, resultSelector) {
  ...
  var _a = __read(
    isEventTarget(target) ? eventTargetMethods.map(function(methodName) {
      return function(handler) {
        return target[methodName](eventName, handler, options);
      };
    }) : isNodeStyleEventEmitter(target) ? nodeEventEmitterMethods.map(
      toCommonHandlerRegistry(target, eventName)
    ) : isJQueryStyleEventEmitter(target) ? jqueryMethods.map(toCommonHandlerRegistry(target, eventName)) : [],
    2
...
//# sourceMappingURL=chunk-W6D5JP5O.js.map
